              ...
              <table id="example1" class="table table-bordered table-striped" style="width:100%">
                ...
                @foreach ($unregistered_users as $user)
                  <tr>
                    ...
                    <td>{{ $user->email}}</td>
                    <td class="block-td"><a href="{{ route('makeComplete',['user_id'=>$user->id,'task_id'=>$task_id]) }}"><button type="button" class="btn btn-block btn-success">Mark Complete</button></a></td>
