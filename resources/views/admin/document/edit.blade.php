        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Health Form</h3>
            </div>


            <!-- /.box-header -->
            <!-- form start -->
              <form role="form" action="{{ route('health-forms.update', $document->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  {{ method_field('PUT') }}
              ...
              <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <div class="form-group">
                     <label for="age">Select Age</label>
                      <div class="input-group">
                         ...
                         <input id="age" type="text" name="age" value="{{ $document->age }}" class="form-control">
                         <span class="input-group-btn">
                  ...
                  <div class="row">
                      <div class="col-sm-2 col-2">
                          <div class="form-group">
                              ...
                              <div class="file-upload">
                                  <label for="file">
                                      @php
                                        $ext=substr($document->url,-3);
                                        if($ext=='pdf'){
                                        echo '<img src="'.asset('public/pdf.png').'" id="file_thumbernail"
                                           style="width:65px;height:80px;">';
                                        }
                                      else{
                                      echo '<img src="'.asset('public/doc.png').'" id="file_thumbernail"
                                           style="width:65px;height:80px;">';
                                      }
                                      @endphp
                                  </label>
                      ...
                      <div class="col-sm-8 col-10">
                          <h4 id="doc-title" style="margin-top:50px;font-size:22px;">{{$document->title}}</h4>
                      </div>
                  </div>
              </div>
              </div>
