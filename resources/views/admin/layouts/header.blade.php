<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        {{--<span class="logo-lg"><b>PTI</b>Health</span>--}}
        <img src="{{asset('public/guest/images/logo_admin.png')}}" style="height:40px;width:auto;margin-top:5px; margin-bottom:10px;">
    </a>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                            ...
                            {{--<ul class="menu">--}}
                                {{--<li><!-- start message -->--}}
                                    {{--<a href="#">--}}
                                        {{--<div class="pull-left">--}}
                                            ...
                                            {{--<img src="{{asset('public/admin/dist/img/user2-160x160.jpg')}}" class="user-circle" alt="User Image">--}}
                                        {{--</div>--}}
                                        {{--<h4>--}}
                                            {{--Support Team--}}
                                ...
                                {{--<li>--}}
                                    {{--<a href="#">--}}
                                        {{--<div class="pull-left">--}}
                                            ...
                                            {{--<img src="{{asset('public/admin/dist/img/user4-128x128.jpg')}}" class="user-circle" alt="User Image">--}}
                                        {{--</div>--}}
                                        {{--<h4>--}}
                                            {{--Developers--}}
                                ...
                                {{--<li>--}}
                                    {{--<a href="#">--}}
                                        {{--<div class="pull-left">--}}
                                            {{--<img src="../public/admin/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">--}}
                                            {{--<img src="{{asset('public/admin/dist/img/user3-128x128.jpg')}}" class="user-circle" alt="User Image">--}}
                                        {{--</div>--}}
                                        {{--<h4>--}}
                                            {{--Sales Department--}}
                ...
                <li>
                    <a href="{{route('admin.logout')}}" style="padding-top:13px;padding-bottom:10px;"><i class="fa fa-sign-out" style="font-size:20px"></i></a>
                </li>
            </ul>
        </div>
    </nav>
