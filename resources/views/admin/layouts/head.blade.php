...
<title>PTI Health | Dashboard</title>
...
{{--Dashboard Icon font--}}
{{--<link rel="stylesheet" type="text/css" href="{{asset('public/admin/dashboard_font/css/dashboard_font.css')}}">--}}
<link rel="stylesheet" type="text/css" href="{{ asset('public/user/custom_icon/css/custom_icon.css')}}">

<style>
.add-new,.btn-success,.btn-primary,.btn-warning{
background:#7cc242;
}
</style>
