      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="send_alert" method="post">
            {{ csrf_field() }}
            {{--{{ method_field('PUT') }}--}}
              <div class="box-body">
              <div class="col-lg-offset-3 col-lg-6">
                <div class="form-group">
                  ...
                  <form>
                      <textarea class="textarea" name="alert_body" placeholder="Alert Content Here"
              ...
              <div class="form-group">
                ...
                <a href="alert_page" class="btn btn-warning">Back</a>
              </div>
